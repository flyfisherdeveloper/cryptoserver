...
public class SandboxBinanceExchangeController {
    private final ExchangeService sandboxBinanceService;

    public SandboxBinanceExchangeController(ExchangeService sandboxBinanceService) {
    ...
    public CoinDataFor24Hr get24HourTicker(@PathVariable String symbol) {
        CoinDataFor24Hr data = sandboxBinanceService.get24HourCoinData(symbol).orElse(null);
        return data;
    }
