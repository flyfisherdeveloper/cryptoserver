...
@ContextConfiguration(classes = {BinanceExchangeController.class, BinanceExchangeService.class, BinanceUrlExtractor.class,
        RestTemplate.class, CachingConfig.class, CacheUtilImpl.class})
@WebMvcTest
